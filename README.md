...
## 字形特征
1. 高可读性，等宽无衬线，中英文 2:1 宽完美对齐
2. 丰富字重，智能连字，Nerd Font，Hints 原生支持
3. 实时更新，构建合成发布全流程自动化
4. JetBrains Mono (英文字形) + Maple Mono (中文字形) 双字形
5. 中英文字形由前后文自动选择，选择逻辑:
...
* 北京时间: <!--BJT_TIME-->2025-02-21 20:39:36<!--BJT_TIME-->
* UTC 时间: <!--UTC_TIME-->2025-02-21 12:39:36<!--UTC_TIME-->
