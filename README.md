...
## 注意事项
如果你在 Visual Studio 中使用本字体，请务必在 `设置 -> 环境 -> 高级` 中将 `文本格式设置方法` 设为 `理想`，否则可能会导致字体渲染极度不均匀
...
* 北京时间: <!--BJT_TIME-->2025-03-06 12:36:25<!--BJT_TIME-->
* UTC 时间: <!--UTC_TIME-->2025-03-06 04:36:25<!--UTC_TIME-->
